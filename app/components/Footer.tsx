  ...
  return (
    <footer className="border-t border-line">
      <div className="mx-auto flex max-w-6xl flex-col gap-4 px-4 py-8 text-sm text-dim sm:flex-row sm:items-center sm:justify-between">
        <span className="flex items-center gap-2 text-accent"><Logo size={18} /><span className="text-dim">Look At This</span></span>
        <nav className="flex flex-wrap gap-x-5 gap-y-2">
          ...
          <a href="mailto:hello@lookatthis.app" className="hover:text-ink">{tr("footer.contact")}</a>
        </nav>
      </div>
    </footer>
  );
